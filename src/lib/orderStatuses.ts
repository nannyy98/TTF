export const ORDER_STATUSES = [
  ...
  { value: 'shipping',         label_ru: 'В доставке',    label_uz: 'Yetkazilmoqda',          color: 'bg-surface-800 text-white',                                                              dot: 'bg-white' },
  { value: 'delivered',        label_ru: 'Доставлен',     label_uz: 'Yetkazildi',             color: 'bg-surface-900 text-white',                                                              dot: 'bg-white' },
  ...
  { value: 'paid',             label_ru: 'Оплачен',       label_uz: "To'langan",              color: 'bg-surface-900 text-white',                                                              dot: 'bg-white' },
